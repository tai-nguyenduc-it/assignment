...
@Composable
internal fun rememberShimmerEffect(theme: com.widget.base.shimmer.ShimmerTheme): ShimmerEffect {
...
internal class ShimmerEffect(
    ...
    fun ContentDrawScope.draw(shimmerArea: com.widget.base.shimmer.ShimmerArea) = with(shimmerArea) {
